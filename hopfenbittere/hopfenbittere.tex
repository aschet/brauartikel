...
\begin{equation}
\mathit{GA} = \frac{\mathit{GB} - 0,05}{0,2}
\label{eq:ragerga}
\end{equation}
...
\toprule
\multicolumn{1}{c}{\textbf{Kochzeit [min]}} & \multicolumn{7}{c}{\textbf{Ausbeute [\%] per spezifischer Dichte [g/ml]}}  \\
                                             & 1,030 & 1,040 & 1,050 & 1,060 & 1,070 & 1,080  & 1,090                      \\
\midrule
...
\begin{equation}
\mathit{GF} = 1,65 \cdot 0,000125^{(\overline{SG}\:[g/ml] - 1)}
\label{eq:tinsethgf}
\end{equation}

\begin{equation}
\mathit{TF} = \frac{1 - e^{(-0,04 \cdot t\:[min])}}{4,15}
\label{eq:tinsethtf}
\end{equation}

\begin{equation}
\mathit{U\:[\%]} = \mathit{GF} \cdot \mathit{TF} \cdot 100
...
\toprule
\multicolumn{1}{c}{\textbf{Kochzeit [min]}} & \multicolumn{5}{c}{\textbf{Ausbeute [\%] per spezifischer Dichte [g/ml]}}                                 \\
                                             & 1,032–50 & 1,050–65 & \multicolumn{1}{l}{1,065–75} & \multicolumn{1}{l}{1,075–85} & \multicolumn{1}{l}{1,085–95}  \\
\midrule                                             
0                                            & 5        & 4        & 4                            & 4                            & 3                             \\
5                                            & 5        & 5        & 5                            & 4                            & 4                             \\
15                                           & 8        & 8        & 7                            & 7                            & 7                             \\
...
spezifischen Dichte von 1,085–95 wurde in \autoref{table:noonanutilpellets}
korrigiert.
