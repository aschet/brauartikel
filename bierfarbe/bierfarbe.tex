...
In einer neueren Publikation wurde der Korrekturfaktor für die Stammwürze inzwischen zu \autoref{eq:hanghoferfstw2019} angepasst. \textcite[78]{Hanghofer2019}
...
\bottomrule
\end{tabular}
\caption{Pilsner mit 11,7~°P Stw. \parencite{KrausWeyermann2022}}
\label{table:pilsner}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Dunkles mit 12,3~°P Stw. \parencite{KrausWeyermann2022}}
\label{table:dunkles}
\end{table}
