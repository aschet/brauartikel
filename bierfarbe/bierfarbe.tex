...
In der erweiterten zweiten Ausgabe des Buchs „\citetitle{Burch2010}“ stellt \textcite[102]{Burch2010} das Berechnungsverfahren in \autoref{eq:mcuburch} vor. Er geht dabei von einer gesamten Maischedauer von 90~Minuten aus. Nachdem das Buch von Burch von 1986 bis 2010 mehrere Überarbeitungen auch innerhalb derselben Ausgabe erfahren hat, ist das Jahr der Veröffentlichung unklar.
...
Die Rechenblätter von Noonans Buch „\citetitle{Noonan1996}“ enthalten die Korrelation von \autoref{table:mcunoonan}. \textcite{Druey1998} formulierte hierzu die Exponentialfunktion in \autoref{eq:mcunoonandruey}, die in Verbindung mit \autoref{eq:mcubasis} zu verwenden ist.
