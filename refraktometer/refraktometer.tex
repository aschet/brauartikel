...
\begin{figure}[h]
\centering
\includegraphics[width=8cm]{data_fermentation_graph.pdf}
...
\toprule
\textbf{Korrelation} & \textbf{Mittlere Abw. (°P)} & \textbf{Standardabw. (°P)} & \textbf{Endabw. (°P)} & \textbf{R²} \\
\midrule
Gardner & -0.683 & 0.204 & -0.472 & 0.974 \\
Bonham & -0.543 & 0.119 & 0.554 & 0.984 \\
Terrill Linear & -1.827 & 2.145 & 0.349 & 0.616 \\
Terrill Kubisch & 1.335 & 3.182 & 0.206 & 0.443 \\
Gosett & -0.331 & 0.216 & -0.482 & 0.992 \\
Novotný Linear & -0.201 & 0.246 & -0.014 & 0.995 \\
Novotný Quadratisch & -0.270 & 0.162 & -0.124 & 0.995 \\
\bottomrule
\end{tabular}
\caption{Abweichung bei Vergärung mit Stammwürze von 17 °P}
\label{table:novotnydev}
\end{table}
