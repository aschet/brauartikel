...
Auch wenn sich die Einheiten Grad Brix und Grad Plato beide auf
wässrige Saccharoselösungen beziehen, ein auf Grad Brix
kalibriertes Refraktometer sollte bei gleicher Stammwürze einen
höheren Messwert liefern als ein Aräometer. Der Grund hierfür ist,
dass Würze noch weitere gelöste Bestandteile enthält, die sich auf den
Brechungsindex auswirken. Messwerte müssen dementsprechend durch einen
Korrekturfaktor (Wort Correction Factor, \wcftext) angepasst
werden. Zur Ermittlung der Stammwürze in Grad Plato ist daher 
...
sollte deshalb im Optimalfall pro Rezept mit Hilfe einer Aräometermessung
gemäß \autoref{eq:calcwcf} bestimmt werden. Ein gängiger Wertebereich
für diesen ist 1,02 bis 1,06. Der etablierte Durchschnittswert
entspricht 1,04.  \autocite{Bonham2001,BSHB2010,Roberts1950,Terrill2013}
...
\section*{Kalibrierung und Justage}

Um Sicherzustellen, dass ein Messgerät 
...
\caption{Durchführung der Messung}
\label{fig:refactomeasure}
\end{figure}



\section*{Korrelationsmodelle}
...
\begin{equation}
\mathit{AE}\:[\degree P]=1,53 \cdot \bxf - 0,59 \cdot \bxic
\label{eq:gardner} 
\end{equation}

\begin{align}
\begin{split}
\abw\:[\%\:w/w] &= (277,8851 - 277,4 \cdot \fg + 0,9956 \bxf + 0,00523 \cdot \bxf^2 + 0,000015 \cdot \bxf^3) \\
& \quad \cdot \fg / 0,79
...
und „\href{https://www.maischemalzundmehr.de/index.php?inhaltmitte=toolsrefraktorechner}{Maische, Malz und Mehr}“ für
Messungen während der Gärung empfohlen. \autocite{Bonham2001,Terrill2010a}

Das Bonham Modell besteht aus einer Gleichung zur Bestimmung der
spezifischen Dichte des scheinbaren Restextrakts (\autoref{eq:bonham})
und einer Gleichung zur Bestimmung des Alkoholgehalts in Volumenprozent
(Alcohol by Volume, \abvtext, \autoref{eq:bonhamabv}).

\begin{align}
\begin{split}
\fg\:[SG] &= 1,001843 - 0,002318474 \cdot \bxic - 0,000007775 \cdot \bxic^2 -
...
\begin{align}
\begin{split}
\abv\:[\%\:v/v] &= 1,001843 - 0,002318474 \cdot \bxic - 0,000007775 \cdot \bxic^2 -
0,000000034 \cdot \bxic^3 \\
& \quad + 0,00574 \cdot \bxf +
0,00003344 \cdot \bxf^2 + 0,000000086 \cdot \bxf^3
...
\begin{equation}
\fg\:[SG] = 1 - 0,00085683 \cdot \bxic + 0,0034941 \cdot \bxfc
\label{eq:terrilllinear} 
\end{equation}

\begin{align}
\begin{split}
\fg\:[SG] &= 1 - 0,0044993 \cdot \bxic + 0,011774 \cdot \bxfc + 0,00027581 \cdot \bxic^2 - 0,0012717 \cdot \bxfc^2 \\
...
\begin{tabular}{lrrrr}
\toprule
Korrelation &  Mittlere Abw. [°P] &  Standardabw. [°P] & Max. Abw. [°P] & Abw. < 0,5 °P [\%] \\
\midrule
Bonham & -0,4 & 0,6 & -2,1 & 41 \\
Terrill Kubisch & 0,2 & 0,3 & 1,2 & 85 \\
Terrill Linear & 0,03 & 0,4 & 1,0 & 84 \\
\bottomrule
\end{tabular}
...
verfälscht diesen bei 20~°C um 0,445 Grad Brix. 
...
\begin{equation}
\aex\:[\degree P] = \bxic - \frac{\abw \cdot (2,0665 - 1,0665 \cdot \bxic / 100)}{0,8052}
\end{equation}
...
\begin{equation} 
\fg\:[SG] = -0,002349 \cdot \bxic + 0,006276 \cdot \bxfc + 1
\label{eq:novotnylinear} 
\end{equation}

\begin{align}
\begin{split}
\fg\:[SG] &= 1,335 \cdot 10^{-5} \cdot \bxic^2 - 3,239 \cdot 10^{-5} \cdot \bxic \cdot \bxfc + 2,916 \cdot 10^{-5} \cdot \bxfc^2 \\
...
\begin{equation}
\sg = \frac{\degree P}{258,6 - \mathit{P} / 258,2 \cdot 227,1} + 1
\end{equation}

\begin{equation}
\degree P = -205,347 \cdot \sg^2 + 668,72 \cdot \sg - 463,37
\end{equation}

\begin{equation}
\rex\:[\degree P] = 0,1948 \cdot \oex + 0,8052 \cdot \aex
\end{equation}
...
\fg\:[SG] = 1 - 0,00085683 \cdot 11,54 + 0,0034941 \cdot 5,77 &= 1,010 \\
\aex\:[\degree P] = -205,347 \cdot 1,010^2 + 668,72 \cdot 1,010 - 463,37 &= 2,63 \\
\rex\:[\degree P] = 0,1948 \cdot 11,54 + 0,8052 \cdot 2,63 &= 4,37 \\
