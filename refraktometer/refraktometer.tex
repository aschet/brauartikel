...
spezifische Dichte eine Referenztemperatur angegeben, im Normalfall 20~°C.
Bei Abweichungen von dieser Referenz ist eine Messwertkorrektur durchzuführen.
Messwerte der Skala müssen je nach Aräometer über oder unter dem
gebildeten Flüssigkeitsmeniskus abgelesen werden.
\autocite{Kunze2004,Narziss2009,Spedding2016}

% TODO Plato
Mit  Im Gegensatz zu Europa wird im amerikanischen Raum meist die spezifische
Dichte von Würze in Bezug auf Wasser gemessen. 
g Extrakt / 100g Bier = Plato.

Die Umrechnung zwischen Masseanteil in Grad Plato und der Massendichte
erfolgt auf Basis der Plato Tabellen über die Lincoln Gleichungen
(\autoref{eq:calcptosg}, \autoref{eq:calcsgtop}) oder vergleichbare
...
Präzisions Geräte DIN 12791-1 
Die Genauigkeit der Saccharometeranzeige ist nur bei geeichten
...
Probe gut durchmischen. kein Wasser am Hydrometer trocken
sein, nicht zu tief eintauchen um Würze Anhaftung zu vermeiden
Saccharometer trocken sein
ungefähr Temperatur haben wie die zu messende Flüssigkeit;
Messgefäß rein und mit der zu spindelnden Flüssigkeit vorgespült
das Messgefäß muss in der Waage stehen
Messgefäß muss so weit sein, dass das Saccharometer, ohne zu großen
Spielraum, bequem Platz findet;
vor dem Ablesen mehrmals rasch eingetaucht und
wieder herausgezogen, um anhaftende Gasblasen zu entfernen;
Abkühlen der Würze wird durch Abdecken eine Verdunstung vermieden;
Flüssigkeit durch mehrmaliges
Stürzen zu mischen.
...
And at the end of the day I think that's all we can really conclude. For my own data (40 batches) the results look like:

    Terrill Linear: Mean Dev -0.0003, Std Dev 0.0014

    Terrill Cubic: Mean Dev 0.0001, Std Dev 0.0013

    Novotny Linear: Mean Dev -0.0015, Std Dev 0.0020

    Novotny Cubic: Mean Dev -0.0019, Std Dev 0.0021



FG 1.0050-1.0145 (30 batches):

    Terrill Linear: Mean Dev -0.0005, Std Dev 0.0014

    Terrill Cubic: Mean Dev 0.0001, Std Dev 0.0010

    Novotny Linear: Mean Dev -0.0022, Std Dev 0.0020

    Novotny Cubic: Mean Dev -0.0027, Std Dev 0.0019

FG 1.0150-1.0240 (10 batches):

    Terrill Linear: Mean Dev 0.0002, Std Dev 0.0014

    Terrill Cubic: Mean Dev 0.0001, Std Dev 0.0018

    Novotny Linear: Mean Dev 0.0001, Std Dev 0.0009

    Novotny Cubic: Mean Dev -0.0002, Std Dev 0.0010
