...
\begin{equation}
\rex\:[\degree P] = -0,29388 \cdot \bxic + 1.27582 \cdot \bxfc
\label{eq:novotnyre}
\end{equation}
...
\fg\:[SG] = -0,002349 \cdot 11,54 + 0,006276 \cdot 5,77 + 1 &= 1,009 \\
\aex\:[\degree P] = -205,347 \cdot 1,009^2 + 668,72 \cdot 1,009 - 463,37 &= 2,34 \\
\rex\:[\degree P] = 0,1948 \cdot 11,54 + 0,8052 \cdot 2,34 &= 4,13 \\
